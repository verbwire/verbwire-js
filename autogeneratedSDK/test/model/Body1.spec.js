...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerbwireApiDocumentation.Body1();
  });
  ...
  describe('Body1', function() {
    it('should create an instance of Body1', function() {
      ...
      //var instane = new VerbwireApiDocumentation.Body1();
      //expect(instance).to.be.a(VerbwireApiDocumentation.Body1);
    });
    ...
    it('should have the property contractSymbol (base name: "contractSymbol")', function() {
      // uncomment below and update the code to test the property contractSymbol
      //var instane = new VerbwireApiDocumentation.Body1();
      //expect(instance).to.be();
    });
