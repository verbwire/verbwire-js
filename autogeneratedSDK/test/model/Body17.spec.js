...
(function(root, factory) {
  ...
  describe('Body17', function() {
    ...
    it('should have the property sourceContractAddress (base name: "sourceContractAddress")', function() {
      // uncomment below and update the code to test the property sourceContractAddress
      //var instane = new VerbwireApiDocumentation.Body17();
      //expect(instance).to.be();
    });

    it('should have the property destContractAddress (base name: "destContractAddress")', function() {
      // uncomment below and update the code to test the property destContractAddress
      //var instane = new VerbwireApiDocumentation.Body17();
      //expect(instance).to.be();
    });
