...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerbwireApiDocumentation.Body8();
  });
  ...
  describe('Body8', function() {
    it('should create an instance of Body8', function() {
      ...
      //var instane = new VerbwireApiDocumentation.Body8();
      //expect(instance).to.be.a(VerbwireApiDocumentation.Body8);
    });

    it('should have the property mintQty (base name: "mintQty")', function() {
      // uncomment below and update the code to test the property mintQty
      //var instane = new VerbwireApiDocumentation.Body8();
