...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerbwireApiDocumentation.NFTDataInner();
  });
  ...
  describe('NFTDataInner', function() {
    it('should create an instance of NFTDataInner', function() {
      // uncomment below and update the code to test NFTDataInner
      //var instane = new VerbwireApiDocumentation.NFTDataInner();
      //expect(instance).to.be.a(VerbwireApiDocumentation.NFTDataInner);
    });
