...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new VerbwireApiDocumentation.SalesEvent();
  });
  ...
  describe('SalesEvent', function() {
    it('should create an instance of SalesEvent', function() {
      // uncomment below and update the code to test SalesEvent
      //var instane = new VerbwireApiDocumentation.SalesEvent();
      //expect(instance).to.be.a(VerbwireApiDocumentation.SalesEvent);
    });
    ...
    it('should have the property orderSide (base name: "orderSide")', function() {
    ...
    it('should have the property saleUsd (base name: "saleUsd")', function() {
      // uncomment below and update the code to test the property saleUsd
      //var instane = new VerbwireApiDocumentation.SalesEvent();
      //expect(instance).to.be();
    });
